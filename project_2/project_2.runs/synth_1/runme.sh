...
HD_PWD='C:/SPB_Data/learngit/fpga_project/fpga20181001_2_lcd1602/project_2/project_2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log lcd1602.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source lcd1602.tcl
