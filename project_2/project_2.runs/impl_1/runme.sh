...
HD_PWD='C:/SPB_Data/learngit/fpga_project/fpga20181001_2_lcd1602/project_2/project_2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log lcd1602.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source lcd1602.tcl -notrace
